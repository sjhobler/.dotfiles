...
require('lazy').setup({
  ...
  --      lspconfig.pyright.setup {
  --        on_new_config = function(new_config, _)
  --          local python = vim.fn.expand '~/.local/bin'
  --          if lspconfig.util.path.is_dir(python) then
  --            new_config.cmd[1] = python .. '/pyright'
  --          end
  --        end,
  --      }
  --    end,
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      --vim.cmd.colorscheme 'vesper' --base16-black-metal-bathory'
  ...
  -- luasnip-latex-snippets (port of Gilles Castel's snippets https://github.com/gillescastel/latex-snippets)
  -- {
  --   "iurimateus/luasnip-latex-snippets.nvim",
  --   dependencies = {
  --     'L3MON4D3/LuaSnip',
  ...
  --   config = function()
  --     require('luasnip-latex-snippets').setup()
  --     require('luansip').config.setup { enable_autosnippets = true }
  --   end,
  -- },
